...
const StageTooltip3D: React.FC<StageTooltip3DProps> = ({
  stage,
  position,
  onClose,
}) => {
        ...
        <div className="flex items-center gap-1.5 mb-2">
          <div
            ...
            style={{
              ...
              boxShadow: `0 0 6px ${statusColors[stage.status]}`,
            }}
          />
          <span
            className="uppercase tracking-wider text-[8px] font-semibold"
            style={{ color: statusColors[stage.status] }}
          >
            {stage.status}
          </span>
          <span className="ml-auto text-white/40 text-[8px]">
