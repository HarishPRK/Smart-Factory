...
export const mockOEEMetrics: OEEMetrics = {
  machineId: "plc-1",
  timestamp: Date.now(),
  availability: { value: 0.94, percentage: "94.0%" },
  performance: { value: 0.88, percentage: "88.0%" },
  quality: { value: 0.985, percentage: "98.5%" },
  oee: { value: 0.815, percentage: "81.5%" },
  plannedProductionTimeSec: 28800,
  runTimeSec: 27072,
  plannedDowntimeSec: 720,
  unplannedDowntimeSec: 1008,
  totalCycles: 1248,
  goodCycles: 1229,
  rejectCycles: 19,
  idealCycleTimeSec: 24,
  shiftId: "morning",
};
